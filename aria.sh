...
aria2c --enable-rpc --check-certificate=false \
   ...
   --peer-id-prefix=-qB4.4.0beta30- --user-agent=qBittorrent/4.4.0beta3 --peer-agent=qBittorrent/4.4.0beta3 \
